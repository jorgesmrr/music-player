...
public class TvBrowseActivity extends Activity
    ...
    public static final String SAVED_MEDIA_ID="br.jm.music.MEDIA_ID";
    public static final String BROWSE_TITLE = "br.jm.music.BROWSE_TITLE";
